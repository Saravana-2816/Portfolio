# Portfolio Website — Build Prompt for Codex
...
Paste this whole file as your first message to Codex, or save it as `AGENTS.md` in a new, empty project folder and run `Codex` from inside it — Codex reads `AGENTS.md` automatically as persistent context for the session. Everything under a "Content" heading below is final copy — use it as-is.
